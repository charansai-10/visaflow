...
VISA_TYPES_SEED = [
    ...
    },
    {
        ...
        "requires_employer_sponsor": True,
        "description": (
            "For executives, managers, or specialized knowledge employees "
            "transferring to a U.S. office."
        ),
        "display_order": 3,
    },
    {
    ...
    },
    {
        ...
        "description": (
            "For individuals who possess extraordinary ability in the "
    ...
    },
    {
        ...
        "category": "student",
        "requires_employer_sponsor": True,
        # STEM OPT requires employer training plan (I-983)
        "required_documents": [
            "Passport Copy", "EAD Card", "I-20",
