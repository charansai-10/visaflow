      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <img src={LOGO_ICON} alt="VisaFlow" className="w-8 h-8" />
            <span className="text-lg font-semibold text-gray-900">VisaFlow</span>
          </div>
        ...
        <aside className="hidden lg:block w-72 shrink-0 sticky top-8">
          ...
          >
            ...
            <p className="text-indigo-200 text-sm mb-6">
              Help us personalize your VisaFlow experience
            </p>
        ...
        <main className="flex-1 min-w-0">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-500 mb-6">Customize your VisaFlow experience</p>
