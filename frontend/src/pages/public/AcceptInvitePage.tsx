...
//             <ShieldCheck size={18} />
//           </div>
//           <span className="text-[18px] font-bold text-[#0f172a] tracking-[-0.5px]">VisaFlow</span>
//         </Link>
//         <a href="mailto:support@visaflow.com"
...
//           immigration case management workspace on VisaFlow.
//         </p>
